 ...
 */
public class TWAgentWorkingMemory_ {
	...
	public TWAgentWorkingMemory_(TWAgent moi, Schedule schedule, int x, int y) {
	 ...
	 * @see TWAgentWorkingMemory_#updateMemory(sim.util.Bag, sim.util.IntBag, sim.util.IntBag)
	 */
	 ...
	 *
	 * @see TWAgentWorkingMemory_#getNearbyObject(int, int, double, java.lang.Class)
	 */
